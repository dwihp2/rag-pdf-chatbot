...
## Corpus Check
- 86 files · ~120,530 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 559 nodes · 925 edges · 64 communities (27 shown, 37 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 36 edges (avg confidence: 0.77)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0aaf518f`
...
1. `cn()` - 136 edges
2. `RAG Chatbot v2 Full Rewrite Plan` - 18 edges
3. `Button()` - 16 edges
4. `compilerOptions` - 16 edges
5. `prisma` - 11 edges
6. `README.md — RAG PDF Chatbot Overview` - 11 edges
7. `scripts` - 10 edges
8. `auth` - 10 edges
...
### Community 1 - "assistant-ui/thread-list.tsx"
Cohesion: 0.09
Nodes (16): dateGroupLabel(), ThreadListGroup, ThreadListItem(), ThreadListItemGroups(), ThreadListItems(), ThreadListNew, ThreadListRoot(), ThreadListSearch (+8 more)
...
Cohesion: 0.10
Nodes (23): AttachmentPreview(), AttachmentPreviewDialog(), AttachmentPreviewProps, AttachmentThumb(), AttachmentUI(), ComposerAddAttachment(), ComposerAttachments(), useAttachmentSrc() (+15 more)

### Community 5 - "cn"
Cohesion: 0.11
Nodes (32): Separator(), SheetTitle(), Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroup() (+24 more)
...
Cohesion: 0.20
Nodes (4): HoverCardContent, Progress(), ScrollArea(), ScrollBar()
...
Cohesion: 0.20
Nodes (6): Sheet(), SheetContent(), SheetDescription(), SheetFooter(), SheetHeader(), SheetOverlay()

### Community 18 - "chat-home.tsx"
Cohesion: 0.38
Nodes (3): ChatHome(), suggestions, Textarea()
...
- **Why does `cn()` connect `cn` to `assistant-ui/thread-list.tsx`, `attachment.tsx`, `card.tsx`, `thread.tsx`, `tool-fallback.tsx`, `utils.ts`, `reasoning.tsx`, `tool-group.tsx`, `select.tsx`, `sheet.tsx`, `chat-home.tsx`, `markdown-text.tsx`, `floating-chat.tsx`, `document-list.tsx`, `assistant-modal.tsx`, `avatar.tsx`, `tabs.tsx`?**
...
- **Should `assistant-ui/thread-list.tsx` be split into smaller, more focused modules?**
